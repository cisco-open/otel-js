...
import {
  ...
  GrpcClientFunc,
} from '@opentelemetry/instrumentation-grpc/build/src/grpc/types';
...
import {
  ...
  getMetadata,
} from '@opentelemetry/instrumentation-grpc/build/src/grpc/clientUtils';
import { _methodIsIgnored } from '@opentelemetry/instrumentation-grpc/build/src/utils';
