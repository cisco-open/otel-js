 ...
 */
// Based on https://github.com/open-telemetry/opentelemetry-js/blob/main/experimental/packages/opentelemetry-instrumentation-grpc/src/grpc-js/clientUtils.ts

import { GrpcJsInstrumentation } from './instrumentation';
import type {
  GrpcClientFunc,
...
/**
 * Execute grpc-js client call. Apply completitionspan properties and end the
...
export function getMetadata(
  ...
  let metadataIndex = args.findIndex((arg: unknown | grpcJs.Metadata) => {
    return (
      arg &&
      typeof arg === 'object' &&
      (arg as grpcJs.Metadata)['internalRepr'] && // changed from _internal_repr in grpc-js --> @grpc-js/grpc-js-js https://github.com/grpc/grpc-node/blob/95289edcaf36979cccf12797cc27335da8d01f03/packages/grpc-js/src/metadata.ts#L88
